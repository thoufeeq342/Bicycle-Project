 ...
 */
class UpdateData extends \Magento\Framework\App\Helper\AbstractHelper
{
    /**
    ...
    {
        $moduleEtcPath = $this->_modulesReader->getModuleDir(\Magento\Framework\Module\Dir::MODULE_ETC_DIR, 'MagicToolbox_MagicZoom');
